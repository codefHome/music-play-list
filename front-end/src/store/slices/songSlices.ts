...
import {  FetchSongwithPagination, FetchSongwithPaginationState, PaginationType,  } from "../../interfaces/songTypes";
...
const songSlices = createSlice({
  ...
  reducers: {
    ...
    fetchSongsStart(state,action: PayloadAction<PaginationType>) {
      state.loading = true;
      state.error = null;
    },
